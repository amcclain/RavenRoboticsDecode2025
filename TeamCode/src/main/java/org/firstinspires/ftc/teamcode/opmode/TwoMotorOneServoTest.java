...
@TeleOp(name="Two Motor One Servo Test", group="Test OpModes")
public class TwoMotorOneServoTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            boolean OPressed = gamepad1.b;
            telemetry.addData("Button O", OPressed);
            if (OPressed){
