...
@Autonomous(name = "Blue Far (OLD)", group = "robot")
@Disabled  // Replaced by BlueFarAuto - delete after testing new code
public class Blue_Far_Auto extends LinearOpMode{
    ...
    String ballOrder;
    final double countsPerInch = 41;
    final double countsPerDegree = 10.5;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStarted()){
            ...
            telemetry.addLine("");
            telemetry.addLine("adjustable inches is: " + adjustableInches);
            telemetry.addLine("adjustable degrees is: " + adjustableDegrees);
            telemetry.addLine("");
