...
/**
 * Red team close starting position autonomous.
...
public class RedCloseAuto extends BaseAutonomous {
    ...
    protected void runAutonomousRoutine() throws InterruptedException {
        ...
        // Turn right to face ball pickup
        turnDegrees("right", 0.8, 57);
        Wait(750);
        ...
        // Turn left to face tower
        turnDegrees("left", 0.8, 58);
        Wait(750);
